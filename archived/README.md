...
| [Flux LoRA Inference](Flux_LoRA_Inference.ipynb) | 2026-09 | `black-forest-labs/FLUX.1-krea-dev` (the only serverless image-LoRA serving) was deprecated 2026-05-27 with no replacement. The current FLUX.2 models reject `image_loras`. |
