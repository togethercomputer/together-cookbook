...
| -------- | ----------- | ---- |
| [Serial Prompt Chaining Agent Workflow](https://github.com/togethercomputer/together-cookbook/blob/main/Serial_Chain_Agent.ipynb) | An agent workflow to generate audio podcasts from PDFs.| [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/togethercomputer/together-cookbook/blob/main/Serial_Chain_Agent.ipynb) |
